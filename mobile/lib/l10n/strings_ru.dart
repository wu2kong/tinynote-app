...
final stringsRu = AppStrings(
  ...
  gitSyncSslFailed:
      'Не удалось проверить сертификат сервера. Проверьте URL репозитория и доверяет ли устройство этому сертификату.',
  ...
  proStoreLegal:
      'Подписка автоматически продлевается, пока вы не отмените её в настройках аккаунта Apple. Покупая, вы соглашаетесь с:',
  proStorePrivacy: 'Политика конфиденциальности',
  proStoreTerms: 'Условия использования (EULA)',
