...
[![下载最新版](https://img.shields.io/github/v/release/wu2kong/tinynote-app?label=下载&style=flat-square)](https://github.com/wu2kong/tinynote-app/releases/latest)
...
- **多种笔记格式** — 块笔记本、Markdown笔记、文章笔记
- **Markdown 源码模式** — 笔记以 Markdown 存储，可直接编辑源码，亦可用任意编辑器或 Git 打开
- **Git 多源同步** — GitHub、Gitee、GitLab、阿里云 Codeup、AtomGit，以及 TinyNote 官方 Git
- **AI 问答** — 接入 OpenAI 兼容模型，密钥只存在本机
- **官方样例库** — 首次启动可导入入门空间，学习软件使用方法
...
👉 [前往 GitHub Releases 下载最新版](https://github.com/wu2kong/tinynote-app/releases/latest)
