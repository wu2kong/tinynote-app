...
export const enMessages = {
  ...
  "settings": {
    ...
    "sync": {
      ...
      "panelDesc": "Choose one sync method. Git can back up notes to multiple hosting platforms; cloud drive sync is coming later.",
      ...
      "modeCloudDesc": "Sync through iCloud, Nutstore, OneDrive, and similar drives.",
      "modeCloudSoon": "Coming soon",
      "changeMode": "Change sync method",
      "cloudPlaceholderTitle": "Cloud drive sync is not available yet",
      "cloudPlaceholderDesc": "This option is reserved. Use Git sync for now, or wait for a later update.",
